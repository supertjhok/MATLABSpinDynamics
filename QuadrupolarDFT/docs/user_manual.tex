...
but still under-predicts the measured value, and the residual is physical rather
than numerical. Because the measurement is a finite-temperature average over an
order--disorder ferroelectric, thermal libration (the harmonic workflow above,
and beyond it snapshot averaging) is the leading candidate for the remainder. The
ranked plan for closing the $\eta$ gap --- convergence, geometry and dispersion,
functional, and dynamics --- is in \code{docs/eta\_accuracy\_improvement.md}.
