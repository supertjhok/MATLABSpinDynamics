...
class ExampleSmokeTests(unittest.TestCase):
    ...
    def test_non_plot_examples_run(self) -> None:
        commands = [
            ...
            (
                "examples/grape_nqr_multi_axis_slse.py",
                "--n-theta",
                "2",
                "--n-phi",
                "2",
    ...
    def test_receiver_array_cpmg_example_writes_png(self) -> None:
        LOCAL_TMP.mkdir(exist_ok=True)
        output = LOCAL_TMP / f"receiver_array_{uuid.uuid4().hex}.png"
        result = run_example(
    ...
    def test_receiver_array_sense_example_writes_png(self) -> None:
        LOCAL_TMP.mkdir(exist_ok=True)
        output = LOCAL_TMP / f"receiver_array_sense_{uuid.uuid4().hex}.png"
        result = run_example(
    ...
    def test_plot_examples_expose_cli_without_matplotlib(self) -> None:
        scripts = [
            ...
            "examples/plot_epm_closed_loop_controller.py",
            "examples/plot_epm_dynamic_inversion.py",
            ...
            "examples/plot_nqr_quadrupolar_survey.py",
            ...
            "examples/plot_grape_detector_aware_pulse.py",
            "examples/plot_squid_ulf_crossover.py",
            "examples/plot_opm_nqr_detection.py",
            "examples/plot_gradiometer_sensitivity.py",
        ...
        result = run_example(
            "examples/plot_electropermanent_magnet.py", "--help"
        )
        self.assertIn("--remanence-t", result.stdout)
        self.assertIn("--n-cross", result.stdout)
        result = run_example(
            "examples/plot_electropermanent_programming.py", "--help"
        )
        ...
        result = run_example(
            "examples/plot_epm_hybrid_array_synthesis.py", "--help"
        )
        self.assertIn("--panel-gap-mm", result.stdout)
        self.assertIn("--transport-gradient-mt-per-m", result.stdout)
        result = run_example(
            "examples/plot_epm_nonlinear_tissue_imaging.py", "--help"
        )
        ...
        result = run_example(
            "examples/plot_epm_closed_loop_controller.py", "--help"
        )
        self.assertIn("--capture-goal", result.stdout)
        self.assertIn("--transport-min", result.stdout)
        result = run_example(
            "examples/plot_epm_dynamic_inversion.py", "--help"
        )
        self.assertIn("--polarizing-mt", result.stdout)
        self.assertIn("--gradient-field-mt", result.stdout)
        ...
        result = run_example("examples/plot_quadrupolar_relaxation_workflow.py", "--help")
        self.assertIn("--efg-fluctuation-khz", result.stdout)
        result = run_example("examples/plot_field_cycling_nmrd.py", "--help")
        self.assertIn("--temperatures-k", result.stdout)
        ...
        self.assertIn("--nutation-khz", result.stdout)
        result = run_example("examples/plot_nqr_higher_spin_slse.py", "--help")
        self.assertIn("--echo-spacing-us", result.stdout)
        self.assertIn("--t2e-ms", result.stdout)
        result = run_example("examples/plot_nqr_quadrupolar_survey.py", "--help")
        self.assertIn("quadrupolar", result.stdout)
        ...
        self.assertIn("--tau-c-us", result.stdout)
        self.assertIn("--ref-tau-c-us", result.stdout)
        self.assertIn("--nutation-khz", result.stdout)
        ...
        result = run_example("examples/plot_nqr_rfi_frequency_domain.py", "--help")
