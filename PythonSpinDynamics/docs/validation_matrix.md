...
| Bayesian experiment design and adaptive acquisition | Bayesian updates, goal utilities, planner-validated adapters, batched PGSE parity, surrogate validation, staged/adaptive scoring, discrete-target nuisance marginalization, and robustness diagnostics follow their stated numerical and decision-theory contracts. | **A**, **R** | partially validated |
...
- **Claim:** Bayesian updates, goal utilities, planner-validated adapters, batched PGSE parity, surrogate validation, staged/adaptive scoring, discrete-target nuisance marginalization, and robustness diagnostics follow their stated numerical and decision-theory contracts.
- **Evidence:** A, R (partially validated)
- **Basis:** Direct Bayes-rule and dense mutual-information calculations, prior-predictive coverage, deterministic replay, facade binding tests, batched-vs-facade PGSE parity, exact polynomial recovery, held-out surrogate errors, linear-Gaussian screening limits, nuisance-only target-information cancellation, discrepancy variance addition, model dispatch, and recommendation sensitivity cases.
