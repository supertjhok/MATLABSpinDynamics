...
| Coupled receiver networks, resonant cancellation, and active LNAs | Loaded sensitivity, passive noise covariance, shared-capacitor cancellation, and separated active-LNA voltage/current noise reduce to analytical multiport limits while mutual resistance remains after mutual reactance is cancelled. | **A**, **R** | partially validated |
...
### Coupled receiver networks, resonant cancellation, and active LNAs

- **Claim:** Loaded sensitivity, passive noise covariance, shared-capacitor cancellation, and separated active-LNA voltage/current noise reduce to analytical multiport limits while mutual resistance remains after mutual reactance is cancelled.
- **Evidence:** A, R (partially validated)
- **Basis:** Exact two-loop mesh equations, fluctuation-dissipation noise covariance, active one-port voltage/current/cross-noise identities, single-frequency agreement with the receiver-network solver, and reciprocal passive-matrix invariants.
...
- **Metric:** Residual mutual reactance, induced-current isolation, loaded transfer-matrix agreement, separated output-noise covariance, noise figure, optimal array SNR, and noise correlation
