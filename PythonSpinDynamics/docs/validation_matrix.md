...
- **Basis:** Closed-form Stokes and rotational Einstein limits, published Tirado finite-cylinder diffusion expressions, the Nacev 2015 pulse order and timing, seeded stochastic trajectory regression, and exact architecture pulse-count identities.
...
- **Metric:** Translational and rotational drag/diffusion, orientation-memory time, repulsive gradient fraction, RMS-radius concentration gain, target retention and escape, seeded repeatability, state/channel pulse count, timing margin, waveform fidelity, and average power when energy inputs are supplied
- **Tolerance:** Floating-point analytical drag/diffusion identities; exact seeded trajectory equality; qualitative contraction for the compact rigid long-rod case and expansion for its 100 ns internal-relaxation control; exact integer hardware counts.
...
- **Reproduce:** [`tests/test_electropermanent_dynamic_inversion.py::test_sphere_drag_recovers_stokes_and_rotational_limits`](https://github.com/supertjhok/MRSpinDynamics/blob/main/PythonSpinDynamics/tests/test_electropermanent_dynamic_inversion.py#L37); [`tests/test_electropermanent_dynamic_inversion.py::test_rod_diffusion_matches_tirado_finite_cylinder_expressions`](https://github.com/supertjhok/MRSpinDynamics/blob/main/PythonSpinDynamics/tests/test_electropermanent_dynamic_inversion.py#L62); [`tests/test_electropermanent_dynamic_inversion.py::test_seeded_dynamic_inversion_is_reproducible_and_nonsticky`](https://github.com/supertjhok/MRSpinDynamics/blob/main/PythonSpinDynamics/tests/test_electropermanent_dynamic_inversion.py#L102); [`tests/test_electropermanent_dynamic_inversion.py::test_rigid_long_rod_contracts_while_fast_moment_relaxation_expands`](https://github.com/supertjhok/MRSpinDynamics/blob/main/PythonSpinDynamics/tests/test_electropermanent_dynamic_inversion.py#L151); [`tests/test_electropermanent_dynamic_inversion.py::test_architecture_counts_and_waveform_consequences_are_explicit`](https://github.com/supertjhok/MRSpinDynamics/blob/main/PythonSpinDynamics/tests/test_electropermanent_dynamic_inversion.py#L216); [`examples/plot_epm_dynamic_inversion.py`](https://github.com/supertjhok/MRSpinDynamics/blob/main/PythonSpinDynamics/examples/plot_epm_dynamic_inversion.py)
