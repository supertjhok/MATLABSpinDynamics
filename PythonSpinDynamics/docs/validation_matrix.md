...
- **Tested range:** Scalar/vector real and complex Gaussian observations; finite Cartesian grids and weighted particles; finite candidate spaces; CPMG-IR, deterministic PGSE, NQR FID, and ESR Hahn adapters; polynomial response surfaces; discrete target/model labels.
